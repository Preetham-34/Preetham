...
with st.sidebar:
    ...
    st.caption("Configure TURN/Twilio in Secrets for webcam on Streamlit Cloud.")
...
st.write("---")
st.caption("Mock mode is enabled. Implement real loaders under src/models/* and set MOCK_MODE=false to switch.")
